package com.jiwei.viwepagerfragmentsample.BottomNavigator;
...
public class BottomNavigationViewHelper {
    ...
    public static void setBottomNavigationColor(Context context, BottomNavigationView bottomNavigationView) {
        int[][] states = new int[][]{
